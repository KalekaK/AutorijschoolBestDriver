...
<div class="container-fluid">
    <div class="row">
        <nav class="col-auto sidebar pt-3">
            <ul class="nav flex-column gap-1-1">
                ><a href="<?= BASE_URL ?>/pages/dashboard.php" class="nav-link">Dashboard</a></l/li>
                ><a href="<?= BASE_URL ?>/pages/admin/les-overzicht.php" class="nav-link">Lesoverzicht</a></l/li>
                ><a href="<?= BASE_URL ?>/pages/admin/lespakket.php" class="nav-link active">Lespakket</a></l/li>
                ><a href="<?= BASE_URL ?>/pages/admin/klant-overzicht.php" class="nav-link">Klanten</a></l/li>
                ><a href="<?= BASE_URL ?>/pages/admin/instructeur-overzicht.php" class="nav-link">Instructeurs</a></l/li>
                ><a href="<?= BASE_URL ?>/pages/admin/wagenpark.php" class="nav-link">Wagenpark</a></l/li>
        ...
        <form method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        abel class="form-label">Code</label>
